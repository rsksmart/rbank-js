...
describe('Market handler', () => {
  ...
  context('Events', () => {
    ...
    beforeEach(async () => {
      ...
      const market2Address = await Market.create(token2._address, 10);
